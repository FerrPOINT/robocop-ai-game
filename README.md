...
- *He…pth and Lives*: The player's health and lives count are displayed on the screen.
- *Bullets and Shooting**: Use the space bar to shoot bullets and destroy enemies.
- *Collision Detection*ä¢ The game checks for collisions between the player, bullets, and enemies.
